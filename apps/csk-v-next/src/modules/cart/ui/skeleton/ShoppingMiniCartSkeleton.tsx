...
import { ShoppingMiniCartItemSkeleton } from './ShoppingMiniCartItemSkeleton';

type ShoppingMiniCartSkeletonProps = {
  itemsCount?: number;
};

export const ShoppingMiniCartSkeleton: FC<ShoppingMiniCartSkeletonProps> = ({ itemsCount = 2 }) => (
  <div className="relative flex h-full animate-pulse flex-col">
    ...
    <div className="mt-16 box-border flex flex-col">
      {[...Array(itemsCount)].map((_, idx) => (
        <ShoppingMiniCartItemSkeleton key={idx} />
      ))}
