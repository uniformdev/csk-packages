...
export const Button: FC<ButtonProps> = ({
  ...
  const baseStyles = cn(
    'block w-max font-medium focus-visible:outline-none !no-underline focus-visible:ring-1 disabled:pointer-events-none disabled:opacity-50',
    {
  ...
  const linkStyles = cn('bg-transparent hover:opacity-100', {
