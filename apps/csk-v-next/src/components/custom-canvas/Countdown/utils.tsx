...
export const renderNumberList = ({
  ...
  <div className="relative mx-auto h-[1.1em] w-[1.75em] overflow-hidden">
    <div
      className="absolute transition-transform duration-500 ease-in-out"
      style={{ transform: `translateY(-${currentTime * 1.1}em)` }}
    >
      {Array.from(
        ...
        (_, unitNumber) => (
          <div
            key={`${unit}-${unitNumber}`}
            className={cn('flex h-[1.1em] w-[1.75em] justify-center', {
