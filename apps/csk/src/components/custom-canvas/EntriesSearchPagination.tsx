...
const EntriesSearchPagination: FC<EntriesSearchPaginationProps & EntriesSearchPaginationParameters> = ({
  siblingCount,
}) => {
...
export default withFlattenParameters(EntriesSearchPagination);
