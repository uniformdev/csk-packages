...
import { Card as CSKCard, CardProps as CSKCardProps } from '@uniformdev/csk-components/components/canvas/serverClient';
...
export default withFlattenParameters(FlexCard);
