...
type FeaturedSectionProps = ComponentProps<SectionParameters>;
...
const FeaturedSection: FC<FeaturedSectionProps & SectionParameters> = ({
  ...
  const sectionContent = <UniformSlot name={SectionSlots.SectionContent} />;
  const sectionCTA = <UniformSlot name={SectionSlots.SectionCTA} />;
  const sectionMedia = <UniformSlot name={SectionSlots.SectionMedia} />;
