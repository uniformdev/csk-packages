...
const EntriesSearchTotalAmount: FC<EntriesSearchTotalAmountProps & EntriesSearchTotalAmountParameters> = ({
  textTemplate,
  textColor,
}) => {
...
export default withFlattenParameters(EntriesSearchTotalAmount);
