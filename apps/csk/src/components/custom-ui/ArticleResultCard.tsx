  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-y-4">
        ...
        {author && <p className="text-base">{author.name}</p>}
        <Button className="mt-auto border border-button-secondary bg-button-secondary px-6 py-3 text-sm uppercase text-text-primary hover:bg-button-secondary hover:text-text-primary">
          {cardButtonText}
        </Button>
      </div>
    </Link>
