  ...
  return (
    ...
    >
      <div className="basis-3/5">
        <div className={cn('font-bold block uppercase', { 'md:hidden': variant === 'default' })}>{itemTitle}</div>
      ...
      <div className={cn('flex flex-row justify-between basis-2/5', { 'md:pt-12 md:pb-8': variant === 'default' })}>
        <div>
          <div className={cn('font-bold block pb-2', { 'md:hidden': variant === 'default' })}>{quantityTitle}</div>
          {updateItemQuantity ? (
            <ProductQuantityItem
        ...
        <div>
          <div className={cn('font-bold block pb-2', { 'md:hidden': variant === 'default' })}>{priceTitle}</div>
