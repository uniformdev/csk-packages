...
export const ShoppingCartSkeleton: FC<ShoppingCartSkeletonProps> = ({
  itemsCount = 2,
  itemTitle = 'ITEM',
  quantityTitle = 'QTY',
  priceTitle = 'PRICE',
  ...
  <Container className="md:pt-14 lg:mb-8">
    <div className="flex animate-pulse flex-col gap-4 text-black">
      <div className="hidden flex-row border-b pb-4 font-bold md:flex">
        <div className="basis-3/5">{itemTitle}</div>
        <div className="basis-1/5">{quantityTitle}</div>
        <div className="basis-1/5 text-right">{priceTitle}</div>
      </div>
