...
const PromptButton: FC<PromptButtonProps> = ({ prompt, showThinking, sendPresetPrompt }) => {
  return (
    <button
      ...
      className={cn(
        'w-full border px-4 py-2 bg-button-secondary text-text-primary hover:bg-button-secondary-hover hover:text-text-primary transition-all duration-300 ease-in-out',
        {
