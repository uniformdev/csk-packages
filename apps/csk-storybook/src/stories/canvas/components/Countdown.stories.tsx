...
const argTypes: Partial<ArgTypes<CountdownParameters>> = {
...
export const WithDaysCountdown = getStory({
  futureDateSettings: { daysAhead: 10 },
});
export const WithBackgroundColor = getStory({
  backgroundColor: 'button-tertiary',
});
export const WithLabelsUnderVariant = getStory({
  variant: CountdownVariants.LabelsUnder,
});
