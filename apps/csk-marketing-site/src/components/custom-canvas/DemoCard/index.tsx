...
// import { CANVAS_EDITOR_STATE, LinkParamValue } from '@uniformdev/canvas';
...
// type DemoCardProps = ComponentProps<DemoCardParameters, DemoCardSlots>;

// const DemoCard: FC<DemoCardProps & ReplaceFieldsWithAssets<DemoCardParameters, 'previewImage'>> = ({
//   anchor,
//   slots,
//   backgroundColor,
//   spacing,
...
//   const [_isCopy, _setIsCopy] = useState(false);
//   const [resolvedImage] = previewImage || [];
...
//   const isContextualEditing = context.pageState.compositionState === CANVAS_EDITOR_STATE;
...
// export default withFlattenParameters(DemoCard);
