...
export {
  default as ComponentEmptyPlaceholder,
  type ComponentEmptyPlaceholderProps,
  type ComponentEmptyPlaceholderParameters,
} from '../ui/ComponentEmptyPlaceholder';
...
export { default as SimpleFooter, type SimpleFooterProps, type SimpleFooterParameters } from './SimpleFooter';
